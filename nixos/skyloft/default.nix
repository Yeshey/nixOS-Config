...
# Go to Oracle Cloud > Your VM Instance > Resources (below) > Console Connection > Launch Cloud Shell Connection (You might have to delete the current connection and create a new one in "Create local connection" with you public key)
