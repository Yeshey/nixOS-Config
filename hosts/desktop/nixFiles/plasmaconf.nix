# nix run github:pjones/plasma-manager > plasmaconf.nix

{
    ...
    shortcuts = {
      ...
      "khotkeys"."{a1900d2e-ca83-4ddc-997d-cb42a915356c}" = "Meta+Shift+S";
    ...
    files = {
      ...
      "dolphinrc"."ExtractDialog"."HDMI-0 Height 1920x1080" = 560;
      "dolphinrc"."ExtractDialog"."HDMI-0 Width 1920x1080" = 1280;
      ...
      "dolphinrc"."Open-with settings"."History" = "androi,and,android,intel,int,inte,cod,stre,visua";
      "dolphinrc"."PreviewSettings"."Plugins" = "audiothumbnail,comicbookthumbnail,djvuthumbnail,ebookthumbnail,exrthumbnail,imagethumbnail,jpegthumbnail,kraorathumbnail,opendocumentthumbnail,svgthumbnail,windowsexethumbnail,windowsimagethumbnail,directorythumbnail,blenderthumbnail,mobithumbnail,fontthumbnail,ffmpegthumbs,rawthumbnail,gsthumbnail";
      "kactivitymanagerdrc"."activities"."79ce0400-9285-47c3-93fd-eb7647332578" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "79ce0400-9285-47c3-93fd-eb7647332578";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1045,662";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "DP-0=1;DP-1=1;HDMI-0=1;DP-2=1;DP-3=1;DP-4=1;";
      "kdeglobals"."KShortcutsDialog Settings"."Dialog Size" = "600,480";
      "kdeglobals"."PreviewSettings"."MaximumRemoteSize" = 0;
      "kdeglobals"."Shortcuts"."ZoomIn" = "Ctrl+=; Ctrl++; Meta++";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{5c015156-e050-44bb-be90-cae8d3328dca}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{5f79657b-5a81-42cc-8239-3e530ff8d87b}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{04d81b1e-0907-4e50-aba2-35937918b077}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{e757f834-5f7d-4c10-98fd-c70032866b10}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{c62ab999-6770-4ddd-9b13-4c4844e96375}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{98d0e020-192f-4053-847f-df5c07726e70}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{024adeb0-9bee-4716-b4d8-c3dc8f70a1e5}";
      ...
      "khotkeysrc"."Data_4_1"."Comment" = "run terminal";
      "khotkeysrc"."Data_4_1"."Enabled" = true;
      "khotkeysrc"."Data_4_1"."Name" = "Konsole";
      "khotkeysrc"."Data_4_1"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_1Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_1Actions0"."CommandURL" = "konsole";
      ...
      "khotkeysrc"."Data_4_1Triggers0"."Key" = "Ctrl+Alt+T";
      "khotkeysrc"."Data_4_1Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_1Triggers0"."Uuid" = "{4010362e-cfa5-4fd6-8d75-de63cf5d9034}";
      "khotkeysrc"."Data_4_2"."Comment" = "shortcut of part of the screen to clipboard";
      "khotkeysrc"."Data_4_2"."Enabled" = true;
      "khotkeysrc"."Data_4_2"."Name" = "Screenshot";
      "khotkeysrc"."Data_4_2"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_2Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_2Actions0"."CommandURL" = "spectacle -bcr";
      ...
      "khotkeysrc"."Data_4_2Triggers0"."Key" = "Meta+Shift+S";
      "khotkeysrc"."Data_4_2Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_2Triggers0"."Uuid" = "{a1900d2e-ca83-4ddc-997d-cb42a915356c}";
      "khotkeysrc"."Data_4_3"."Comment" = "Comment";
      "khotkeysrc"."Data_4_3"."Enabled" = true;
      "khotkeysrc"."Data_4_3"."Name" = "AllMusic";
      "khotkeysrc"."Data_4_3"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_3Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_3Actions0"."CommandURL" = "vlc /mnt/DataDisk/PersonalFiles/Timeless/Music/AllMusic/";
      ...
      "khotkeysrc"."Data_4_3Triggers0"."Key" = "Ctrl+Alt+M";
      "khotkeysrc"."Data_4_3Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_3Triggers0"."Uuid" = "{5672d8e8-9555-48c8-a6d2-aa3943a7dcf4}";
      "khotkeysrc"."Data_4_4"."Comment" = "Comment";
      "khotkeysrc"."Data_4_4"."Enabled" = true;
      "khotkeysrc"."Data_4_4"."Name" = "StudyMusic";
      "khotkeysrc"."Data_4_4"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_4Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_4Actions0"."CommandURL" = "vlc \"/mnt/DataDisk/PersonalFiles/Timeless/Music/Músicas de Estudo.m3u8\"";
      ...
      "khotkeysrc"."Data_4_4Triggers0"."Key" = "Ctrl+Alt+E";
      "khotkeysrc"."Data_4_4Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_4Triggers0"."Uuid" = "{ce415970-9c71-469c-838d-4a1854249f9c}";
      ...
      "kwalletrc"."Wallet"."Default Wallet" = "wallet";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Compositing"."OpenGLIsUnsafe" = true;
      "kwinrc"."Desktops"."Id_1" = "5fda6d87-9a66-4460-bd4e-c339e314f1a3";
      "kwinrc"."Desktops"."Id_2" = "e348d2a4-82a6-4410-b068-06c8fc2ba955";
      "kwinrc"."Desktops"."Id_3" = "a25e6ea8-fcd2-4a69-bb45-9c17661f08bf";
      "kwinrc"."Desktops"."Id_4" = "c2419754-f320-402c-b9af-c28d32fdfe4a";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 2;
      "kwinrc"."Effect-blur"."BlurStrength" = 4;
      "kwinrc"."Effect-blur"."NoiseStrength" = 2;
      "kwinrc"."Effect-desktopgrid"."BorderActivate" = 1;
      "kwinrc"."Effect-kwin4_effect_glitch"."Duration" = 380;
      "kwinrc"."Effect-windowview"."BorderActivate" = 7;
      "kwinrc"."Effect-windowview"."BorderActivateAll" = 9;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 40.2057;
      "kwinrc"."NightColor"."LongitudeAuto" = "-8.4213";
      ...
      "kwinrulesrc"."1"."Description" = "Dock transparency";
      "kwinrulesrc"."1"."opacityactive" = 65;
      "kwinrulesrc"."1"."opacityactiverule" = 2;
      "kwinrulesrc"."1"."opacityinactive" = 65;
      "kwinrulesrc"."1"."opacityinactiverule" = 2;
      "kwinrulesrc"."1"."types" = 4;
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."Description" = "Dock transparency";
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."opacityactive" = 65;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."opacityactiverule" = 2;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."opacityinactive" = 65;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."opacityinactiverule" = 2;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."types" = 4;
      "kwinrulesrc"."b897778d-6736-41b5-a782-9ce2273246b1"."wmclassmatch" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_GB.utf8";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "/mnt/DataDisk/PersonalFiles/Timeless/Pictures/Decoration Images/Background Pictures/blackHoleAIGenerated.png,/mnt/DataDisk/PersonalFiles/Timeless/Pictures/Decoration Images/Background Pictures/unknown.png,/mnt/DataDisk/PersonalFiles/Timeless/Pictures/Decoration Images/Background Pictures/Deviantart/Deconstruction of Shooting Stars.png,/mnt/DataDisk/PersonalFiles/Timeless/Pictures/Background Pictures/free4kwallpapers/blue-dragon-symbol-wallpaper.jpg,/mnt/DataDisk/PersonalFiles/Timeless/Pictures/Background Pictures/free4kwallpapers/the-ringaround-wallpaper.jpg";
      "systemsettingsrc"."KFileDialog Settings"."detailViewIconSize" = 16;
      "systemsettingsrc"."Open-with settings"."CompletionMode" = 1;
      "systemsettingsrc"."Open-with settings"."History" = "lbr,qbi";
