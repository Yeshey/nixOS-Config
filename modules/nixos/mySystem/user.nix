  ...
  config = {
    ...
    users = {
      ...
      users.${cfg.user} = {
        ...
        extraGroups = [ "networkmanager" "wheel" "dialout" "docker" "adbusers" "libvirtd" "surface-control" "audio"]; # TODO if you ever extend the module to be able to have several users, you need to see how to handle this
