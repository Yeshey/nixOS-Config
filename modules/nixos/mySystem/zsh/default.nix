    ...
    programs.zsh = {
      ...
      interactiveShellInit = ''
        ...
        source ${builtins.toFile "myAlias.zsh" (builtins.readFile ./myAlias.zsh + ''
          ...
          alias update="sudo nixos-rebuild --flake ${cfg.falkeLocation}#${config.mySystem.host} switch --option eval-cache false --max-jobs 2"
          alias update-re="sudo nixos-rebuild --flake ${cfg.falkeLocation}#${config.mySystem.host} boot --option eval-cache false --max-jobs 2 && reboot"
        '')}
