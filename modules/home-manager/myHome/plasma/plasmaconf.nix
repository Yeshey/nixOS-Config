...
in
{
  ...
  config = lib.mkIf cfg.enable {
    programs.plasma = {
      enable = true;
      shortcuts = {
        "ActivityManager"."switch-to-activity-79004a9a-b449-47b0-a377-55c0bfcd6afd" = [ ];
        "ActivityManager"."switch-to-activity-79ce0400-9285-47c3-93fd-eb7647332578" = [ ];
        "ActivityManager"."switch-to-activity-9a5e60c8-dad9-4961-bb85-222d24341d32" = [ ];
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to Portuguese" = [ ];
        ...
        "khotkeys"."{a1900d2e-ca83-4ddc-997d-cb42a915356c}" = [ ];
        "khotkeys"."{cab40507-80f6-48c7-8f6d-64f4fb4fb1fc}" = "Meta+Shift+S";
        "khotkeys"."{ce415970-9c71-469c-838d-4a1854249f9c}" = "Ctrl+Alt+E";
      ...
      configFile = {
        ...
        "dolphinrc"."General"."HomeUrl".value = "/mnt/DataDisk/PersonalFiles";
        ...
        "dolphinrc"."Open-with settings"."History".value = "cod,codi,viva,ark";
        "dolphinrc"."PreviewSettings"."Plugins".value = "audiothumbnail,comicbookthumbnail,djvuthumbnail,ebookthumbnail,exrthumbnail,imagethumbnail,jpegthumbnail,kraorathumbnail,opendocumentthumbnail,svgthumbnail,windowsexethumbnail,windowsimagethumbnail,fontthumbnail,blenderthumbnail,directorythumbnail,ffmpegthumbs,rawthumbnail,gsthumbnail,mobithumbnail";
        "kactivitymanagerdrc"."activities"."79ce0400-9285-47c3-93fd-eb7647332578".value = "Default";
        "kactivitymanagerdrc"."main"."currentActivity".value = "79ce0400-9285-47c3-93fd-eb7647332578";
        ...
        "kdeglobals"."General"."menuFont".value = "Noto Sans,10,-1,5,50,0,0,0,0,0";
        "kdeglobals"."General"."smallestReadableFont".value = "Noto Sans,9,-1,5,50,0,0,0,0,0";
        ...
        "kdeglobals"."KScreen"."ScreenScaleFactors".value = "DP-0=1;DP-1=1;HDMI-0=1;DP-2=1;DP-3=1;DP-4=1;";
        ...
        "kdeglobals"."WM"."activeFont".value = "Noto Sans,10,-1,5,50,0,0,0,0,0";
        ...
        "kglobalshortcutsrc"."plasmawindowed"."_k_friendly_name".value = "plasmawindowed";
        ...
        "khotkeysrc"."Data_1"."DataCount".value = 2;
        ...
        "khotkeysrc"."Data_1_2"."Comment".value = "Global keyboard shortcut to launch Konsole";
        "khotkeysrc"."Data_1_2"."Enabled".value = true;
        "khotkeysrc"."Data_1_2"."Name".value = "Launch Konsole";
        "khotkeysrc"."Data_1_2"."Type".value = "MENUENTRY_SHORTCUT_ACTION_DATA";
        "khotkeysrc"."Data_1_2Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_1_2Actions0"."CommandURL".value = "org.kde.konsole.desktop";
        "khotkeysrc"."Data_1_2Actions0"."Type".value = "MENUENTRY";
        "khotkeysrc"."Data_1_2Conditions"."Comment".value = "";
        "khotkeysrc"."Data_1_2Conditions"."ConditionsCount".value = 0;
        "khotkeysrc"."Data_1_2Triggers"."Comment".value = "Simple_action";
        "khotkeysrc"."Data_1_2Triggers"."TriggersCount".value = 1;
        "khotkeysrc"."Data_1_2Triggers0"."Key".value = "";
        "khotkeysrc"."Data_1_2Triggers0"."Type".value = "SHORTCUT";
        "khotkeysrc"."Data_1_2Triggers0"."Uuid".value = "{76db9847-92c8-4d48-b2f7-4b9355507b44}";
        ...
        "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{5c015156-e050-44bb-be90-cae8d3328dca}";
        ...
        "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{5f79657b-5a81-42cc-8239-3e530ff8d87b}";
        ...
        "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{04d81b1e-0907-4e50-aba2-35937918b077}";
        ...
        "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{e757f834-5f7d-4c10-98fd-c70032866b10}";
        ...
        "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{c62ab999-6770-4ddd-9b13-4c4844e96375}";
        ...
        "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{98d0e020-192f-4053-847f-df5c07726e70}";
        ...
        "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{024adeb0-9bee-4716-b4d8-c3dc8f70a1e5}";
        ...
        "khotkeysrc"."Data_4"."DataCount".value = 4;
        ...
        "khotkeysrc"."Data_4_1"."Comment".value = "run terminal";
        "khotkeysrc"."Data_4_1"."Enabled".value = true;
        "khotkeysrc"."Data_4_1"."Name".value = "Konsole";
        "khotkeysrc"."Data_4_1"."Type".value = "SIMPLE_ACTION_DATA";
        "khotkeysrc"."Data_4_1Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_4_1Actions0"."CommandURL".value = "konsole";
        ...
        "khotkeysrc"."Data_4_1Triggers0"."Key".value = "Ctrl+Alt+T";
        "khotkeysrc"."Data_4_1Triggers0"."Type".value = "SHORTCUT";
        "khotkeysrc"."Data_4_1Triggers0"."Uuid".value = "{4010362e-cfa5-4fd6-8d75-de63cf5d9034}";
        "khotkeysrc"."Data_4_2"."Comment".value = "shortcut of part of the screen to clipboard";
        "khotkeysrc"."Data_4_2"."Enabled".value = true;
        "khotkeysrc"."Data_4_2"."Name".value = "Screenshot";
        "khotkeysrc"."Data_4_2"."Type".value = "SIMPLE_ACTION_DATA";
        "khotkeysrc"."Data_4_2Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_4_2Actions0"."CommandURL".value = "spectacle -bcr";
        ...
        "khotkeysrc"."Data_4_2Triggers0"."Uuid".value = "{a1900d2e-ca83-4ddc-997d-cb42a915356c}";
        "khotkeysrc"."Data_4_3"."Comment".value = "Comment";
        "khotkeysrc"."Data_4_3"."Enabled".value = true;
        "khotkeysrc"."Data_4_3"."Name".value = "AllMusic";
        "khotkeysrc"."Data_4_3"."Type".value = "SIMPLE_ACTION_DATA";
        "khotkeysrc"."Data_4_3Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_4_3Actions0"."CommandURL".value = "vlc /mnt/DataDisk/PersonalFiles/Timeless/Music/AllMusic/";
        ...
        "khotkeysrc"."Data_4_3Triggers0"."Key".value = "Ctrl+Alt+M";
        "khotkeysrc"."Data_4_3Triggers0"."Type".value = "SHORTCUT";
        "khotkeysrc"."Data_4_3Triggers0"."Uuid".value = "{5672d8e8-9555-48c8-a6d2-aa3943a7dcf4}";
        "khotkeysrc"."Data_4_4"."Comment".value = "Comment";
        "khotkeysrc"."Data_4_4"."Enabled".value = true;
        "khotkeysrc"."Data_4_4"."Name".value = "StudyMusic";
        "khotkeysrc"."Data_4_4"."Type".value = "SIMPLE_ACTION_DATA";
        "khotkeysrc"."Data_4_4Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_4_4Actions0"."CommandURL".value = "vlc \"/mnt/DataDisk/PersonalFiles/Timeless/Music/Músicas de Estudo.m3u8\"";
        ...
        "khotkeysrc"."Data_4_4Triggers0"."Key".value = "Ctrl+Alt+E";
        "khotkeysrc"."Data_4_4Triggers0"."Type".value = "SHORTCUT";
        "khotkeysrc"."Data_4_4Triggers0"."Uuid".value = "{ce415970-9c71-469c-838d-4a1854249f9c}";
        "khotkeysrc"."Data_5"."Comment".value = "Comment";
        "khotkeysrc"."Data_5"."Enabled".value = true;
        "khotkeysrc"."Data_5"."Name".value = "printScreen";
        "khotkeysrc"."Data_5"."Type".value = "SIMPLE_ACTION_DATA";
        "khotkeysrc"."Data_5Actions"."ActionsCount".value = 1;
        "khotkeysrc"."Data_5Actions0"."CommandURL".value = "spectacle -bcr";
        "khotkeysrc"."Data_5Actions0"."Type".value = "COMMAND_URL";
        "khotkeysrc"."Data_5Conditions"."Comment".value = "";
        "khotkeysrc"."Data_5Conditions"."ConditionsCount".value = 0;
        "khotkeysrc"."Data_5Triggers"."Comment".value = "Simple_action";
        "khotkeysrc"."Data_5Triggers"."TriggersCount".value = 1;
        "khotkeysrc"."Data_5Triggers0"."Key".value = "Meta+Shift+S";
        "khotkeysrc"."Data_5Triggers0"."Type".value = "SHORTCUT";
        "khotkeysrc"."Data_5Triggers0"."Uuid".value = "{cab40507-80f6-48c7-8f6d-64f4fb4fb1fc}";
        ...
        "khotkeysrc"."Shortcuts"."ZoomIn[$d]".value = "";
        ...
        "klipperrc"."General"."MaxClipItems".value = 500;
        ...
        "kwalletrc"."Wallet"."Default Wallet".value = "wallet";
        "kwalletrc"."Wallet"."First Use".value = false;
        "kwinrc"."Compositing"."OpenGLIsUnsafe".value = false;
        "kwinrc"."Desktops"."Id_1".value = "5fda6d87-9a66-4460-bd4e-c339e314f1a3";
        "kwinrc"."Desktops"."Number".value = 1;
        "kwinrc"."Desktops"."Rows".value = 1;
        "kwinrc"."Effect-desktopgrid"."BorderActivate".value = 1;
        "kwinrc"."Effect-zoom"."MouseTracking".value = 2;
        "kwinrc"."NightColor"."Active".value = true;
        "kwinrc"."NightColor"."LatitudeAuto".value = 40.2057;
        "kwinrc"."NightColor"."LongitudeAuto".value = "-8.4213";
        "kwinrc"."NightColor"."NightTemperature".value = 2700;
        "kwinrc"."Plugins"."minimizeallEnabled".value = true;
        "kwinrc"."Plugins"."wobblywindowsEnabled".value = true;
        "kwinrc"."TabBox"."LayoutName".value = "big_icons";
        "kwinrc"."Tiling"."padding".value = 4;
        "kwinrc"."Tiling/29da56e1-839b-587d-bfa7-8947ad0bdc41"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/44bea82b-2de0-5111-957d-06ed811de8d0"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/53f34b33-25c6-5673-ba17-af328b6835ad"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "kwinrc"."Tiling/5b4f5af0-c5c5-58fd-a297-0db11ee0ebe4"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "kwinrc"."Tiling/83b4a20d-32e4-5437-84d1-2e049fb88c70"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/c897c4f6-72b3-5b9a-8a41-b221a90df985"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/d0ea9c0e-2700-5eca-aa3f-b16568e7a1c6"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."org.kde.kdecoration2"."ButtonsOnLeft".value = "MFS";
        "kxkbrc"."Layout"."DisplayNames".value = ",";
        "kxkbrc"."Layout"."LayoutList".value = "pt,br";
